...
const articles = [
  ...
  },
  {
    ...
    text: "As the air turns crisp, the earth offers a newbounty. A guide to selecting, storing, andsavoring the best organic produce of the fall…",
    time: "4 min read"
  },
  {
    image: image4,
    header: "Generations in the Soil: An Interview with Master Farmer…",
    text: "We sit down with a third-generation stewardof the land to discuss the philosophy of regenerative agriculture and the patience…",
    time: "10 min read"
  },
  {
    image: image5,
