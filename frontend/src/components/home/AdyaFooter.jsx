      ...
      <div style={styles.footerMainGrid}>
        ...
        <div>
          ...
          <p style={styles.brandText}>
            Amruthahara brings natural, wholesome and quality food products
            closer to your home. We make it easier to choose healthy living
            every day.
          </p>
          ...
          <div style={styles.addressBox}>
            ...
            Your trusted destination for natural products, organic living and
        ...
        <div>
          ...
          <ul style={styles.footerLinks}>
            ...
            <li>
              <Link to="/wellness" style={styles.link}>
                Healthy Essentials
              </Link>
            </li>

            <li>
              <Link to="/seasonal-produce" style={styles.link}>
                Fresh Produce
              </Link>
            </li>

            <li>
              <Link to="/millet-range" style={styles.link}>
                Millet Range
              </Link>
            </li>

            <li>
              <Link to="/honey" style={styles.link}>
                Natural Honey
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul style={styles.footerLinks}>
            <li>
              <Link to="/organic-living" style={styles.link}>
                Organic Living
              </Link>
            </li>
        ...
        <div>
          ...
          <div style={styles.newsletterCard}>
            <p style={styles.newsletterText}>
              Subscribe to get seasonal harvest alerts, exclusive discounts &
              updates!
            </p>
      ...
      <div style={styles.bottomBar}>
        <div style={styles.bottomContent}>
          <div style={styles.copyright}>
            Copyright © 2026 HRA Groups Private Limited. All Rights Reserved.
          ...
          <div style={styles.socialLinks}>
            ...
            >
              <svg
                ...
                strokeWidth="2"
              >
                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88-.46 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z" />
