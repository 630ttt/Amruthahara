      ...
      <div style={styles.footerMainGrid}>
        ...
        <div>
          ...
          <ul style={styles.footerLinks}>
            ...
            <li><Link to="/our-story" style={styles.link}>Our Story</Link></li>
        ...
        <div>
          ...
          <ul style={styles.footerLinks}>
            <li><Link to="/products" style={styles.link}>Organic Products</Link></li>
            <li><Link to="/categories" style={styles.link}>Natural Foods</Link></li>
            <li><Link to="/wellness" style={styles.link}>Healthy Essentials</Link></li>
            <li><Link to="/seasonal-produce" style={styles.link}>Fresh Produce</Link></li>
            <li><Link to="/millet-range" style={styles.link}>Millet Range</Link></li>
            <li><Link to="/honey" style={styles.link}>Natural Honey</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul style={styles.footerLinks}>
            <li><Link to="/organic-living" style={styles.link}>Organic Living</Link></li>
            <li><Link to="/privacy-policy" style={styles.link}>Privacy Policy</Link></li>
            <li><Link to="/returns" style={styles.link}>Return & Refund Policy</Link></li>
            <li><Link to="/shipping" style={styles.link}>Shipping & Delivery</Link></li>
